<?php
/* Smarty version 3.1.30, created on 2024-03-03 05:24:24
  from "D:\xampp\htdocs\webshop\smarty\templates\layouts\header.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_65e3fb7842aeb4_42852126',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f93880503662b6f4db28d5060f49c7b12d6d5fc2' => 
    array (
      0 => 'D:\\xampp\\htdocs\\webshop\\smarty\\templates\\layouts\\header.tpl',
      1 => 1709439863,
      2 => 'file',
    ),
  ),
...
function content_65e3fb7842aeb4_42852126 (Smarty_Internal_Template $_smarty_tpl) {
?>
<header class="row">
            ...
            <label>
                <div class="khung-tim-kiem-mobile">
                    <form class="form-inline" method="post" autocomplete="off">
                        <input name="search" id="search-mobile" class="form-control mr-sm-2" type="text" placeholder="Nhập sản phẩm cần tìm">
                    </form>
...
">Gọi ngay: <?php echo $_smarty_tpl->tpl_vars['phone_number']->value;?>
                    ...
                    <li>
                        <div class="khung-tim-kiem-pc">
                            <form class="form-inline" method="post" autocomplete="off">
                                <input name="search" id="search" class="form-control mr-sm-2" type="text" placeholder="Nhập sản phẩm cần tìm">
                            </form>
    ...
    <div id="bsm_header_navigation" class="container">
        ...
        <div class="col-md-2">
            <a href=".">   
            <img src="public/images/logo/<?php echo $_smarty_tpl->tpl_vars['logo']->value;?>
" alt="" style="width: 165px;height: 140px;">
        </a>
        </div>
        <div class="col-md-5">
            <nav>
